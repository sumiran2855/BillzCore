    ...
    <div className="space-y-6 pb-8">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
        ...
        <div className="rounded-xl border p-5" style={{ backgroundColor: "var(--bz-card-bg)", borderColor: "var(--bz-border-hard)" }}>
          <CardHeader title="Job Pipeline" sub={`${totalPipeline} total applicants`} />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
        ...
        <div className="rounded-xl border p-5" style={{ backgroundColor: "var(--bz-card-bg)", borderColor: "var(--bz-border-hard)" }}>
          <CardHeader
            ...
            action={<span className="text-[11px] font-bold px-2 py-0.5 rounded-full" style={{ backgroundColor: "rgba(6,182,212,0.10)", color: "#06B6D4" }}>+31% YoY</span>}
          />
        ...
        <div className="rounded-xl border p-5" style={{ backgroundColor: "var(--bz-card-bg)", borderColor: "var(--bz-border-hard)" }}>
          <CardHeader
            ...
            action={<span className="text-[11px] font-bold px-2 py-0.5 rounded-full" style={{ backgroundColor: "rgba(139,92,246,0.10)", color: "#8B5CF6" }}>↑ 18.4%</span>}
          />
        ...
        {/* Revenue Split Donut */}
        <div className="rounded-xl border p-5" style={{ backgroundColor: "var(--bz-card-bg)", borderColor: "var(--bz-border-hard)" }}>
          <CardHeader title="Revenue Split" sub="By business segment" />
          {/* SVG Donut */}
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
        ...
        <div className="rounded-xl border" style={{ backgroundColor: "var(--bz-card-bg)", borderColor: "var(--bz-border-hard)" }}>
          <div className="flex items-center justify-between px-5 py-3.5 border-b" style={{ borderColor: "var(--bz-border-hard)" }}>
            ...
            <span className="text-[11px] font-bold px-2 py-0.5 rounded-full" style={{ backgroundColor: "rgba(239,68,68,0.10)", color: "#EF4444" }}>
              ₹4.12L overdue
            </span>
          </div>
          <div className="divide-y" style={{ borderColor: "var(--bz-border-hard)" }}>
